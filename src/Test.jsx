...
function Test() {
  ...
  */
  ...
  useEffect(() => {
    ...
    /* 순서
    1. searchTerm이 set되고 바뀌면 onChange에 콜백된 useDebounce훅 호출
    2. setTimeout에 맞춰서 훅 호출완료, debouncedValue 변경 및 반환
    3. 여기있는 debouncedValeu가 변경 되었기에 useEffect가 호출되면서 API call 
     */
  }, [debouncedSearchTerm]);
